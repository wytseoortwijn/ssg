...
-define(state(C, X1, X2, P1, P2), <<C:11, X1:11, X2:11, P1:2, P2:2>>).
...
trans(?state(C, _, X2, ?Q, P2), 0) when C < 400 -> ?state(C, C, X2, ?R, P2);
trans(?state(C, X1, _, P1, ?Q), 1) when C < 400 -> ?state(C, X1, C, P1, ?R);
